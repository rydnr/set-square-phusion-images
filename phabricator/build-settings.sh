...
defineEnvVar MYSQL_VERSION "The MySQL version" "$(docker run --rm -it ${REGISTRY}/${NAMESPACE}/base:${PARENT_IMAGE_TAG} remote-ubuntu-version mysql-server | sed 's/[^0-9a-zA-Z\._-]//g')";
