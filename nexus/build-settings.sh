...
defineEnvVar NEXUS_VERSION MANDATORY "The version of Sonatype Nexus" "3.42.0-01"
...
defineEnvVar SSL_CERTIFICATE_COMMON_NAME MANDATORY "The common name for the SSL certificate" "nexus.acm-sl.org"
