...
# mod: check-version/check-git-version
# api: public
# txt: Checks the versions of the remote and the local repository.
...
setScriptDescription "Checks the versions of the remote and the local repository.";
