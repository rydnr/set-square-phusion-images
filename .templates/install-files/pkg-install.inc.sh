defineEnvVar APTGET_UPDATE MANDATORY "The command to update the system" "apt-get update -y";
defineEnvVar APTGET_INSTALL MANDATORY "The command to install a package" "apt-get install -y";
