defineEnvVar SOURCE MANDATORY "The source folder" "/var/cache/rsnapshot/";
defineEnvVar DESTINATION MANDATORY "The destination folder" "~";
...
defineEnvVar BACKUP_ROOT_FOLDER MANDATORY "The root folder to backup" "/var/cache/rsnapshot";
