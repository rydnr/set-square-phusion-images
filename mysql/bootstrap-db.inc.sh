...
defineEnvVar SERVICE_USER "The service user" "${SERVICE_USER}";
defineEnvVar SERVICE_GROUP "The service group" "${SERVICE_GROUP}";
...
defineEnvVar MYSQL_ROOT_PASSWORD "The root password of the database" "secret";
